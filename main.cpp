...
int main(int argc, char** argv)
{
    ...
    compare_planner(window_name1, window_name2, window_name3, window_name4, width, height, stride,
                    threashold, MaxIteration, rand_precition, radius, grow_rate, dismin, start,
                    end);
